...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" variant="floating" className="border-sidebar-border/50 hidden md:flex">
      ...
      <SidebarFooter className="">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 leading-none group-data-[collapsible=icon]:hidden">
                ...
                <span className="text-xs text-muted-foreground truncate max-w-[140px]">user@example.com</span>
              </div>
          ...
          <DropdownMenuContent side="top" className="w-[--radix-dropdown-menu-trigger-width] min-w-56" align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href="/help" className="cursor-pointer w-full flex items-center">
